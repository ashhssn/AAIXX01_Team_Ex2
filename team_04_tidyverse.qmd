...
scatter_plot_with_loess_ci <- ggplot(yearly_data, aes(x = Year, y = AvgTemperature)) +
  ...
  labs(
    title = "Scatter Plot with LOESS Smoothing and Confidence Interval of Year vs. Average Temperature Uncertainty in Afghanistan",
    x = "Year",
    y = "Average Temperature Uncertainty (°C)",
    caption = "Data Source: [Climate Change: Earth Surface Temperature Data](https://www.kaggle.com/datasets/berkeleyearth/climate-change-earth-surface-temperature-data/data)"
  ) +
  theme_minimal()
